...
const loading: React.FC<loadingProps> = ({}) => {
  return (
    <div className="w-[90%] md:w-[60%] lg:w-[40%] mx-auto mt-4 md:mt-6">
      ...
      <div>
        <div className="flex items-center justify-between gap-x-2 border-2 border-gray-400 rounded-xl p-2 md:px-6">
          <div className="flex items-center gap-x-1">
            <div className="w-14 h-14 rounded-full bg-gray-400"></div>

            <div className="space-y-1">
              <div className="text-xl font-semibold bg-gray-400 h-5 w-36"></div>
              <p className="bg-gray-400 text-sm font-medium h-3 w-24"></p>
            </div>
          </div>
